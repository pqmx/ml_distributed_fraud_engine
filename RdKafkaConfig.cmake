...
set(RdKafka_INCLUDE_DIRS ${librdkafka_INCLUDE_DIRS_RELEASE} )
set(RdKafka_INCLUDE_DIR ${librdkafka_INCLUDE_DIRS_RELEASE} )
set(RdKafka_LIBRARIES ${librdkafka_LIBRARIES_RELEASE} )
set(RdKafka_DEFINITIONS ${librdkafka_DEFINITIONS_RELEASE} )
...
foreach(_BUILD_MODULE ${librdkafka_BUILD_MODULES_PATHS_RELEASE} )
